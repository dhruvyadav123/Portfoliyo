...
import PROFILE_IMG from '../assets/profile-optimized.png';
...
function Hero() {
  ...
  const stats = [
    { val: projectCountLabel, label: 'Projects' },
    { val: '1yr+', label: 'Experience' },
    { val: 'Full Stack', label: 'Focus' },
  ];

  return (
    <section className="relative min-h-[calc(100vh-82px)] overflow-hidden bg-[#0a0a0a] text-white">
      <div className="relative mx-auto max-w-7xl w-full px-4 pb-10 pt-6 sm:px-8 sm:pb-10 sm:pt-8 lg:pb-6 lg:pt-4">
        <div className="flex flex-col-reverse items-center gap-10 lg:flex-row lg:items-center lg:gap-14">
          ...
          <div className="flex-1 w-full max-w-xl mx-auto lg:mx-0 text-center lg:text-left">
            ...
            <Reveal delay={0.05}>
              <h1 className="mb-3 text-4xl font-black leading-[1.05] tracking-tight sm:text-6xl md:text-7xl">
            ...
            <Reveal delay={0.12} className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 justify-center lg:justify-start">
            ...
            <BookText
              delay={0.18}
              text="Building production web and mobile products with React, React Native, Node.js, MongoDB, realtime communication, payment and wallet flows, and reliable cloud deployment."
              className="mt-6 mx-auto lg:mx-0 max-w-lg text-base leading-8 text-gray-400"
            />

            {/* ── Buttons ── */}
            <Reveal delay={0.24} className="mt-8 flex flex-wrap gap-4 justify-center lg:justify-start">
              <Link
                to="/projects"
                className="rounded-full bg-[#eba134] px-7 py-3 text-sm font-bold text-black transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#eba134]/85 hover:shadow-[0_0_25px_#eba13460]"
              >
                View Projects
              </Link>
              <Link
            ...
            {/* ── Social Icons ── */}
            <Reveal delay={0.3} className="mt-8 flex items-center gap-3 justify-center lg:justify-start">
              ...
              <div className="mt-8 border-t border-white/5 pt-5">
                <div className="flex justify-center gap-4 sm:gap-8 lg:justify-start">
                  {stats.map((stat) => (
                    <div
                      key={stat.label}
                      className="flex flex-col items-center lg:items-start rounded-2xl border border-white/8 bg-white/[0.03] px-5 py-4 flex-1 max-w-[110px] lg:max-w-none lg:flex-none lg:px-6 lg:py-4 lg:rounded-none lg:border-0 lg:bg-transparent lg:px-0"
                    >
                      <div className="text-2xl font-black text-[#eba134]">{stat.val}</div>
                      <div className="mt-0.5 text-xs uppercase tracking-wider text-gray-500 text-center lg:text-left">
                        {stat.label}
                      </div>
                    </div>
                  ))}
          ...
          <Reveal delay={0.12} className="flex w-full flex-shrink-0 justify-center lg:flex-1 lg:justify-center">
            <div className="relative">
              <div
                className="absolute -inset-4 animate-spin rounded-full border-2 border-dashed border-[#eba134]/30"
                style={{ animationDuration: '20s' }}
              />
              <div className="absolute -inset-2 rounded-full border border-[#eba134]/20" />

              <div className="relative h-64 w-64 overflow-hidden rounded-full border-4 border-[#eba134]/40 sm:h-80 sm:w-80 lg:h-96 lg:w-96">
