  ...
  return (
    ...
    >
      <div className="mb-5 flex items-start justify-between gap-4">
        <div>
          <div className="mb-3 flex h-14 w-14 items-center justify-center rounded-2xl border border-[#eba134]/20 bg-[#eba134]/10 text-base font-black tracking-[0.18em] text-[#eba134]">
            {project.badge}
          </div>
      ...
      <BookText
        ...
        className="mb-4 text-sm leading-7 text-gray-400"
      />

      <ul className="mb-5 space-y-2.5">
        {project.highlights.map((highlight) => (
          <li key={highlight} className="flex items-start gap-2.5 text-sm leading-6 text-gray-400">
            <span className="mt-2.5 h-1.5 w-1.5 shrink-0 rounded-full bg-[#eba134]" />
            <span>{highlight}</span>
          </li>
        ))}
      </ul>
      ...
      <div className="border-t border-white/8 pt-5">
        {project.live ? (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#eba134] px-5 py-3 text-sm font-black text-black transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#f1b451] hover:shadow-[0_0_22px_#eba13440]"
          >
            Visit Live Website
            <span aria-hidden>↗</span>
          </a>
        ) : (
          <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-[0.2em] text-[#eba134]/80">
    ...
    <section id="projects" className="relative overflow-hidden bg-[#0a0a0a] px-4 py-24 text-white sm:px-8">
      <div className="relative mx-auto max-w-7xl">
        <Reveal className="mb-16 text-center">
          ...
          <BookText
            delay={0.1}
            text="Production-focused work across flight booking, realtime communication, agriculture commerce, fintech, mobile integration, payments, wallets, and admin workflows."
